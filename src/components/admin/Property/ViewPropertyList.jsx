                ...
                <thead className={isDark ? 'bg-[#1b2230]' : 'bg-slate-100'}>
                  <tr className="border-b border-slate-200 dark:border-white/10">
                    ...
                    <th className="px-2 py-2 text-left font-semibold">Title</th>
                                        <th className="px-2 py-2 text-left font-semibold">RefrenceNo</th>
                    ...
                    <th className="px-2 py-2 text-left font-semibold">Location</th>
                                        <th className="px-2 py-2 text-left font-semibold">ListingStart</th>
                                                                                <th className="px-2 py-2 text-left font-semibold">ListingEnd</th>
                    ...
                    <th className="px-2 py-2 text-left font-semibold">OffPlan</th>
                    <th className="px-2 py-2 text-left font-semibold">OwnerDocs</th>
