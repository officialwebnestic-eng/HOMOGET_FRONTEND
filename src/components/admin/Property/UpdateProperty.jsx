...
const UpdateProperty = () => {
  ...
  const [existingDldQRCode, setExistingDldQRCode] = useState(null);
  ...
  const removeExistingOffPlanDocument = (index) => {
    setExistingOffPlanDocuments(prev => prev.filter((_, i) => i !== index));
  };

  const removeExistingOwnerDocument = (index) => {
    setExistingOwnerDocuments(prev => prev.filter((_, i) => i !== index));
  };
          ...
          <div className="flex flex-wrap items-center justify-between py-3 md:py-0 md:h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="hidden xs:inline">{isSubmitting ? "Updating..." : "Update Property"}</span>
                <span className="xs:hidden">{isSubmitting ? "Sync" : "Update"}</span>
              </button>
            </div>
          </div>
        </div>
