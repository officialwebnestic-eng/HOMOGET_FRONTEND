  ...
  import {
    ...
    File, FileCheck, FileWarning, UserCheck, FileSignature, Building
  } from "lucide-react";
  ...
  try {
    ...
    // ✅ Fixed: Properly append all fields to FormData
    ...
    console.log("OffPlan Docs:", offPlanDocuments.length);
    console.log("Owner Docs:", ownerDocuments.length);
