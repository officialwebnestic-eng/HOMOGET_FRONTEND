    ...
    <div className="md:w-3/5 space-y-5 text-center md:text-left">
      ...
      <section className="py-10 px-6 max-w-7xl mx-auto space-y-8 text-start">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <motion.div variants={sectionVariant} initial="hidden" whileInView="visible" className="md:col-span-8 p-10 rounded-[3rem] bg-slate-900 text-white border border-slate-800 relative overflow-hidden">
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-slate-400 text-base text-xl font-serif leading-relaxed">{t.narrativePara}</p>
          ...
          <motion.div variants={sectionVariant} initial="hidden" whileInView="visible" className="md:col-span-4 p-10 rounded-[3rem] bg-amber-600 text-white flex flex-col justify-between">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs font-serif italic leading-relaxed uppercase">{t.strategyPara}</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <motion.div variants={sectionVariant} initial="hidden" whileInView="visible" className="md:col-span-7 p-10 bg-white dark:bg-neutral-900 rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-base text-xl font-serif  tracking-widest text-amber-500">{t.meaningTitle}</span>
            </div>
            <p className="text-base md:text-xl  font-serif dark:text-white leading-snug">{t.meaningPara}</p>
          </motion.div> 
          ...
          <motion.div variants={sectionVariant} initial="hidden" whileInView="visible" className="md:col-span-5 p-10 bg-slate-900 rounded-[3rem] text-white flex flex-col justify-between shadow-xl">
            ...
            <div>
              <h3 className="text-base md:text-xl font-serif uppercase italic mb-2">{t.visionTitle}</h3>
        ...
        >
          <div className="space-y-6">
            ...
            <h2 className="text-xl font-serif dark:text-white uppercase tracking-tighter leading-tight">{t.legalName}</h2>
      ...
      <section className="px-6 max-w-7xl mx-auto pb-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <p className="text-slate-500 font-medium max-w-sm">Everything you need to know about Dubai real estate and HomoGet.</p>
        </div>
