...
import ReportModal from "../../../model/ReportModel.jsx";
import SaveModal from "../../../model/SaveModal.jsx";
...
const PropertyDetailsPage = () => {
  ...
  const handleEmail = () => {
    ...
    const body = encodeURIComponent(
      `Hello ${property?.agentId?.name || 'Agent'},%0A%0A` +
    ...
    window.location.href = `mailto:${property?.agentId?.email}?subject=${subject}&body=${body}`;
  };
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap justify-between items-start sm:items-center gap-3 sm:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 w-full sm:w-auto">
              <div className="flex flex-col">
                <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-amber-500">
                  AED {Number(property.price).toLocaleString()}
                </span>
                {isRent(property) && property.rentedPeriod && (
                  <span className="text-xs text-gray-400">per {property.rentedPeriod?.toLowerCase().replace("per ", "") || "year"}</span>
                )}
              </div>

              <div className="hidden sm:block">
                <div className="bg-gray-100 dark:bg-zinc-800 px-3 py-2 rounded-lg">
                  <p className="text-[8px] uppercase tracking-widest text-zinc-500 dark:text-zinc-400 font-bold">
                    Property Type
                  </p>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-none bg-red-600 hover:bg-red-700 text-white px-3 sm:px-4 py-2.5 sm:py-3 transition-all duration-300 flex items-center justify-center rounded-lg sm:rounded-md shadow-md hover:shadow-lg"
                title="Save Property"
              >
                <HeartIcon size={18} />
              </button>
              ...
              <button
                ...
                className="flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2.5 sm:py-3 transition-all duration-300 flex items-center justify-center rounded-lg sm:rounded-md shadow-lg hover:shadow-xl"
              ...
              <button
                ...
                className="flex-1 sm:flex-none bg-purple-600 hover:bg-purple-700 text-white px-3 sm:px-4 py-2.5 sm:py-3 transition-all duration-300 flex items-center justify-center rounded-lg sm:rounded-md shadow-lg hover:shadow-xl"
          ...
          <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-100 dark:border-zinc-800">
            <div className="flex flex-wrap items-center justify-start gap-4 sm:gap-6 md:gap-8">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-[10px] text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Bedrooms</p>
                  <p className="text-base sm:text-lg font-bold text-gray-800 dark:text-gray-200">{property.bedroom || 0}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-[10px] text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Bathrooms</p>
                  <p className="text-base sm:text-lg font-bold text-gray-800 dark:text-gray-200">{property.bathroom || 0}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-[10px] text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Area</p>
              ...
              {property.refrenceNo && (
                <div className="hidden md:flex items-center gap-2 ml-auto">
                  <div className="px-3 py-1.5 bg-gray-100 dark:bg-zinc-800 rounded-lg">
                    <p className="text-[8px] text-zinc-400 uppercase tracking-wider">Property ID</p>
                    <p className="text-xs font-mono font-medium text-gray-600 dark:text-gray-400">{property.refrenceNo}</p>
                  </div>
                </div>
              )}
            </div>
          ...
          <section>
            ...
            <p className="text-sm md:text-base leading-relaxed text-gray-700 dark:text-gray-300">
              {property.descriptionEn?.length > 300 
                ? `${property.descriptionEn.substring(0, 300)}...` 
            ...
            {property.descriptionEn?.length > 300 && (
              <button
                ...
                className="mt-3 text-amber-500 text-sm font-semibold hover:underline flex items-center gap-1"
              >
      ...
      {isSingle ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3 w-full">
          ...
          <section>
            ...
            {isOffPlanProperty ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <SpecItem label="Offering Type" value={property.offeringType} />
                <SpecItem label="Trakheesi Number" value={property.trakheesiNumber} />
                <SpecItem label="RERA ORN" value={property.reraORN} />
                <SpecItem label="BRN Number" value={property.brnNumber} />
          ...
          {isOffPlanProperty && property.completionPercentage && (
            <section className="p-6 bg-purple-500/5 border border-purple-500/20 rounded-2xl">
              <h3 className="text-[10px] font-black uppercase tracking-[0.5em] text-purple-500 mb-4">Construction Progress</h3>
          ...
          {isRentalProperty && property.cheques && (
            <section className="p-6 bg-blue-500/5 border border-blue-500/20 rounded-2xl">
              <h3 className="text-[10px] font-black uppercase tracking-[0.5em] text-blue-500 mb-4">Payment Terms</h3>
        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-32 space-y-6">
            {/* Agent Card */}
            <div className={`p-5 rounded-2xl ${isDark ? "bg-zinc-900/50 border border-white/10" : "bg-gray-50 border border-gray-200"}`}>
              <h4 className="text-[10px] font-black uppercase tracking-[0.5em] text-amber-500 mb-4">
                Representative
              </h4>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <p className="text-base font-bold uppercase tracking-tight">{agentName}</p>
              ...
              <div className="space-y-2 pt-3 border-t border-zinc-500/10">
              ...
              <div className="mt-5 flex gap-2">
                <button onClick={handleWhatsApp} className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-green-600 text-white text-xs font-bold hover:bg-green-700 transition-all rounded-lg">
                  <FaWhatsapp size={14} /> WhatsApp
                </button>
                <button onClick={handleCall} className="flex-1 py-2.5 bg-amber-500 text-black text-xs font-bold hover:bg-amber-600 transition-all rounded-lg">
                  Call Now
                </button>
                <button onClick={handleEmail} className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-blue-600 text-white text-xs font-bold hover:bg-blue-700 transition-all rounded-lg">
                  <Mail size={14} /> Email
                </button>
              </div>
            </div>
