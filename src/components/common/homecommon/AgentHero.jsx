        ...
        if (data.features) {
          const locations = data.features.map((f) => ({
            ...
            subText:
              ...
              `${f.properties.suburb || ""}, ${f.properties.city || ""}`,
          }));
  ...
  return (
    <div className="relative min-h-[50vh] md:min-h-[80vh] flex items-center justify-center overflow-visible z-[40]">
      <div className="absolute inset-0 z-0">
        <img
          src="https://media.istockphoto.com/id/2227005059/photo/aerial-view-of-dubai-downtown-skyline-and-sheikh-zayed-road-at-twilight.jpg?s=612x612&w=0&k=20&c=ceiuTUIjmJQ43OKhbukSuppBTwG9FJ_CYDNAsMu6H0I="
          alt="bg"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 pt-10 pb-10 md:pb-20">
        <div className="text-center mb-6 md:mb-10">
          <h1 className="text-5xl md:text-9xl font-serif text-white mb-2">
            Homoget<span className="text-amber-500">.</span>
          </h1>
          <p className="text-white/60 text-[8px] md:text-sm font-light uppercase tracking-[0.4em]">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-3xl rounded-full p-1 md:p-1.5 shadow-2xl border border-white/20 flex items-center">
              ...
              <AnimatePresence>
                {showFilters && (
                  <motion.div
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="absolute top-full right-0 pt-4 z-[99] w-[500px]"
                  >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {filterFields?.slice(0, 9).map((field) => (
                          ...
                          >
                            ...
                            {getUniqueValues(propertyList, field.name).map(
                              (opt) => (
            ...
            >
              <span className="hidden md:block font-black uppercase text-[10px] tracking-tight">
                Search Now
              </span>
